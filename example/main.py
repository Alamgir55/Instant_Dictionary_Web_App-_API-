...
def home():
    ...
    jp.Button(a=div2, click = sum_up, in1=in_1, in2=in_2, d = d_output, text="Calculate", classes="border border-blue-500 m-2 py-1 px-4 rounded "
...
def mouse_enter(widget, msg):
    widget.text = "A mouse enter the hoouse!"
